...
{
    return [self MD5ForUpper32Bate:[self MD5ForUpper32Bate:str]];
}
///  Base64 加密
...
{
    return [self DESEncryptString:str keyString:key iv:[key dataUsingEncoding:NSUTF8StringEncoding]];
}
///  DES  解密
+(NSString*)DESDecrypt:(NSString*)str key:(NSString*)key
{
    return [self DESDecryptString:str keyString:key iv:[key dataUsingEncoding:NSUTF8StringEncoding]];
}
//   AES  加密
+(NSString*)AESEncrypt:(NSString*)str key:(NSString*)key
{
    return [self AESEncryptString:str keyString:key iv:[key dataUsingEncoding:NSUTF8StringEncoding]];
}
///  AES  解密
+(NSString*)AESDecrypt:(NSString*)str key:(NSString*)key
{
    return [self AESDecryptString:str keyString:key iv:[key dataUsingEncoding:NSUTF8StringEncoding]];
}
